<div class="content-body">
    <div class="container-fluid mt-3">
        ...
        //Form open
        echo form_open_multipart(base_url('admin/konfigurasi/icon'), 'class="form-validation"');
        ?>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="form-validation">
                        ...
                        <div class="form-group row">
                            <label class="col-lg-4 col-form-label">Upload Icon Baru</label>
                            <div class="col-lg-6">
                                <input type="file" class="form-control" name="icon" placeholder="Upload icon baru" value="<?php echo $konfigurasi->icon ?>" required>
                                <div class="col-lg-6">
                                    Icon lama : <img src="<?php echo base_url('assets/upload/image/' . $konfigurasi->icon) ?>" class="img img-responsive img-thumbnail" width="200">
                                </div>
                            </div>
                        </div>
