                ...
                <div class="card-body">
                    <div class="form-validation">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-6">
                                <input type="number" class="form-control" name="harga_produk" placeholder="Harga produk" value="<?php echo set_value('harga_produk') ?>" required>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-6">
                                <input type="number" class="form-control" name="stok_produk" placeholder="Stok produk" value="<?php echo set_value('stok_produk') ?>" required>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-8">
                                <input type="text" class="form-control" name="keterangan" placeholder="keterangan, berat, ukuran produk" value="<?php echo set_value('keterangan') ?>" required>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-8">
                                <input type="text" class="form-control" name="keyword" placeholder="Keyword (untuk SEO Google)" value="<?php echo set_value('stok_produk') ?>">
                            </div>
                        </div>
