	    ...
	    <div class="flex-w flex-sb">
	        <div class="w-size13 p-t-30 respon5">
	            <div class="wrap-slick3 flex-sb flex-w">
	                ...
	                <div class="slick3">
	                    <div class="item-slick3" data-thumb="<?php echo base_url('assets/upload/image/thumbs/' . $produk->gambar_produk) ?>">
	                    ...
	                    <div class="item-slick2 p-l-15 p-r-15">
	                        ...
	                        <div class="block2">
	                            <div class="block2-img wrap-pic-w of-hidden pos-relative block2-labelnew">
	                                <img src="<?php echo base_url('assets/upload/image/' . $produk_related->gambar_produk) ?>" alt="<?php echo $produk_related->nama_produk ?>">
	                            ...
	                            <div class="block2-txt p-t-20">
	                                <a href="<?php echo base_url('produk/detail/' . $produk_related->sub_produk) ?>" class="block2-name dis-block s-text3 p-b-5">
