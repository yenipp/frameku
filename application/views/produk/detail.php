						...
						<div class="item-slick2 p-l-15 p-r-15">
							...
							<div class="block2">
								<div class="block2-img wrap-pic-w of-hidden pos-relative">
									<img src="<?php echo base_url('assets/upload/frame/' . $produk_related->gambar_produk) ?>" alt="<?php echo $produk_related->nama_produk ?>">

									<div class="block2-overlay trans-0-4">
										<!-- <a type="submit" value="submit" class="block2-btn-addwishlist hov-pointer trans-0-4">
